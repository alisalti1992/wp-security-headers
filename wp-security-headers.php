...
function mam_wordpress_security_headers() {
	...
	header("Content-Security-Policy: default-src 'self'; script-src https: 'unsafe-inline'; style-src https: 'unsafe-inline'; img-src * data:; connect-src *; font-src * data:; frame-src *;");
